...
class LookAheadAnalysis():
    ...
    def lookahead(self, circuit, window_size, function):
    ...
    def find_parallel_Toffolis(circuit):
        ...
        :param circuit:
        :return: a dictionnry where the keys are the indices of the moment which contain Toffolis and the values are
